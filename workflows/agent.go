...
import (
	...
	"adkworkshop.workflows/sequential"
...
func main() {
	...
	blogWriter, err := sequential.SequentialAgent(ctx)
	if err != nil {
		panic(err)
	}
    ...
    adkAgent, err := llmagent.New(llmagent.Config{
        ...
        Instruction: `You are a Blogging assistant there to assist users with blog writing tasks. 
			When engaged, prompt the user for a topic to generate a blog post on.`,
